...
const User_Home = () => {
  ...
  if (isFetching) {
    ...
    return (
      <>
        <div class="">
          <div className="  flex justify-center  bg-[url('https://source.unsplash.com/1600x400/?girls')] bg-cover  ">
            <div className="flex justify-center w-3/5">
              <input
                type="text"
                className="my-36 w-9/12  sm:h-12 rounded-l-xl px-4 outline-none "
                placeholder="Search here..."
                onChange={(e) => searchtags(e)}
              />
              <button className=" my-36 sm:h-12 w-20 rounded-l-none rounded-r-xl  px-4 bg-sky-600  border-0 hover:bg-sky-700">
                <img
        ...
        <div className="flex flex-col lg:flex-row bg-bg">
          ...
          <div className="w-[] lg:w-[340px] bg-white mb-3 mt-3  mr-10 lg:mr-0 lg:ml-3 rounded-sm  block lg:sticky top-3 shadow-md shadow-gray-500 h-fit m-auto">
                      ...
                      <div className="  gap-6 lg:block">
                        ...
                        <div className="block my-1">
                          ...
                          <input
                            ...
                            name="tag"
                            className="mr-2"
                            onChange={() => filtertags("Two-Wheeler")}
                          />
                          Two-Wheeler
                        </div>
                        <div className="block my-1">
                        ...
                        <div className="block my-1">
                          ...
                          <input
                            ...
                            className="mr-2"
                            onChange={() =>
                              filtertags("Clothing_essentials")
                            }
                          />
                          Clothing_essentials
                        </div>
