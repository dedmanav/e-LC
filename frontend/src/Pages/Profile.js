...
import Cards from '../Components/profCard';
                                    ...
                                    <div class="text-white">
                                        <div class="grid md:grid-cols-2 text-sm before:hidden after:hidden">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="px-4 py-2 w-[50%]">IIT (BHU) Varanasi</div>
                                            </div>
                                            <div class="flex">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="px-4 py-2 w-[50%]">
                                                    <a class="text-green-500" href="mailto:jane@example.com">{authUser?.email_id}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
