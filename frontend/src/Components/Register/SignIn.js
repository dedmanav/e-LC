...
const SignIn = () => {
  ...
  const postData = async (e) => {
    ...
    {
      return alert("Only IIT BHU institutional email ID's allowed.");
    }
    ...
    if (data.status === 422 || !data) {
      ...
      window.alert("Only IIT BHU institutional email ID's allowed");
    } 
      ...
      >
        <div class="form-container sign-up-container">
          <form action="#">
            ...
            <span id="Span">Use your @itbhu.ac.in email for registration</span>
            <input
              type="text"
              name="name"
              value={user.name}
